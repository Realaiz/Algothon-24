...
last_trained_day = -1  # Variable to track the last day the model was trained
...
# Function to get the trading position using the trained random forest model
def getMyPosition(prcSoFar):
    global currentPos, last_trained_day, best_model
    ...
    if nt % 21 == 0 or best_model is None:
        # Prepare data
    ...
    pred_ret /= lNorm
    rpos = np.array([int(x) for x in 10000 * pred_ret / prcSoFar[:, -1]])
